...
int main(){
    ...
    int cordtime = 0;
    //auto startcord = 0; auto endcord = 0;
    while(getline(ifs, line)) // read one line from ifs
    {
        ...
        auto startcord = high_resolution_clock::now();
        tuple<double,double> transformed = geoCordTrans(token);
        auto endcord = high_resolution_clock::now();
        //cout << get<0>(transformed) << ',' << get<1>(transformed) << endl;
        double arr[kDimension] = {get<0>(transformed), get<1>(transformed)};
        auto durationCord = duration_cast<microseconds>(endcord - startcord);
        cout << "Time taken to convert a gepgraphic coordinate: " << durationCord.count() << " microseconds" << endl;
    ...
    string latitude = "19.4333"; string longitude = "-99.1333"; 
    //31.1667, 121.4667 -23.5504, -46.6339 37.56, 126.99 19.4333, -99.1333 28.66, 77.23
    string coord = (latitude + ',' + longitude);
    auto startSearch = high_resolution_clock::now();
    tuple<double, double> cart1 = geoCordTrans(coord);
    ...
    cout << "Time taken to search given geographic coordinates in Kd-tree: " << durationSearch.count() << " microseconds" << endl;
    ...
    string latitude2 = "35.6897"; string longitude2 = "139.6922";
    string coord2 = (latitude2 + ',' + longitude2);
    auto startDelete = high_resolution_clock::now();
    tuple<double, double> cart2 = geoCordTrans(coord2);
    ...
    cout << "Time taken to delete given geographic coordinates in Kdtree: " << durationSearch.count() << " microseconds" << endl;
